...
public class AnalyticsWebClient {
    ...
    public String getTest() {
        return (String) getResponse(analyticsWebClientConfig.getTest())
                .bodyToMono(String.class)
                .block(Duration.ofSeconds(analyticsWebClientConfig.getTimeout()));
    }

    public Vessel getVessel() {
        return (Vessel) getResponse(analyticsWebClientConfig.getSvcVessel())
    ...
    public AoiState getSecurityIndicator(@PathVariable int id) {
        return (AoiState) getResponse(analyticsWebClientConfig.getSvcSecurity(), id)
